...
namespace switchadapter_topics {
    ...
    public:
        ...
        public:
            SWITCH_ADAPTER(MessageType& f) : AbstractFactory(f) {
                id.appendMatch16((uint16_t) TOPIC_VAL__TO__SWITCH_ADAPTER);
            }

            class SWITCH_INSTANCE : public AbstractFactory {
            public:
                SWITCH_INSTANCE(MessageType& f, uint64_t value) : AbstractFactory(f) {
                    id.appendMatch64((uint64_t) value);
                }

                class OPENFLOW : public AbstractFactory {
                public:
                    OPENFLOW(MessageType& f) : AbstractFactory(f) {
                        id.appendMatch8((uint8_t) TOPIC_VAL__TO__SWITCH_ADAPTER__SWITCH_INSTANCE__OPENFLOW);
                    }

                    class HELLO : public AbstractFactory {
                    public:
                        HELLO(MessageType& f) : AbstractFactory(f) {
                            id.appendMatch8((uint8_t) TOPIC_VAL__TO__SWITCH_ADAPTER__SWITCH_INSTANCE__OPENFLOW__HELLO);
                        }
                    };

                    class ERROR : public AbstractFactory {
                    public:
                        ERROR(MessageType& f) : AbstractFactory(f) {
                            id.appendMatch8((uint8_t) TOPIC_VAL__TO__SWITCH_ADAPTER__SWITCH_INSTANCE__OPENFLOW__ERROR);
                        }
                    };

                    class ECHO_REQUEST : public AbstractFactory {
                    public:
                        ECHO_REQUEST(MessageType& f) : AbstractFactory(f) {
                            id.appendMatch8(
                                    (uint8_t) TOPIC_VAL__TO__SWITCH_ADAPTER__SWITCH_INSTANCE__OPENFLOW__ECHO_REQUEST);
                        }
                    };

                    class ECHO_REPLY : public AbstractFactory {
                    public:
                        ECHO_REPLY(MessageType& f) : AbstractFactory(f) {
                            id.appendMatch8(
                                    (uint8_t) TOPIC_VAL__TO__SWITCH_ADAPTER__SWITCH_INSTANCE__OPENFLOW__ECHO_REPLY);
                        }
                    };

                    class OF_1_0_VENDOR_OF_1_3_EXPERIMENTER : public AbstractFactory {
                    public:
                        OF_1_0_VENDOR_OF_1_3_EXPERIMENTER(MessageType& f) : AbstractFactory(f) {
                            id.appendMatch8(
                                    (uint8_t) TOPIC_VAL__TO__SWITCH_ADAPTER__SWITCH_INSTANCE__OPENFLOW__OF_1_0_VENDOR_OF_1_3_EXPERIMENTER);
                        }
                    };

                    class FEATURES_REQUEST : public AbstractFactory {
                    public:
                        FEATURES_REQUEST(MessageType& f) : AbstractFactory(f) {
                            id.appendMatch8(
                                    (uint8_t) TOPIC_VAL__TO__SWITCH_ADAPTER__SWITCH_INSTANCE__OPENFLOW__FEATURES_REQUEST);
                        }
                    };

                    class FEATURES_REPLY : public AbstractFactory {
                    public:
                        FEATURES_REPLY(MessageType& f) : AbstractFactory(f) {
                            id.appendMatch8(
                                    (uint8_t) TOPIC_VAL__TO__SWITCH_ADAPTER__SWITCH_INSTANCE__OPENFLOW__FEATURES_REPLY);
                        }
                    };

                    class GET_CONFIG_REQUEST : public AbstractFactory {
                    public:
                        GET_CONFIG_REQUEST(MessageType& f) : AbstractFactory(f) {
                            id.appendMatch8(
                                    (uint8_t) TOPIC_VAL__TO__SWITCH_ADAPTER__SWITCH_INSTANCE__OPENFLOW__GET_CONFIG_REQUEST);
                        }
                    };

                    class GET_CONFIG_REPLY : public AbstractFactory {
                    public:
                        GET_CONFIG_REPLY(MessageType& f) : AbstractFactory(f) {
                            id.appendMatch8(
                                    (uint8_t) TOPIC_VAL__TO__SWITCH_ADAPTER__SWITCH_INSTANCE__OPENFLOW__GET_CONFIG_REPLY);
                        }
                    };

                    class SET_CONFIG : public AbstractFactory {
                    public:
                        SET_CONFIG(MessageType& f) : AbstractFactory(f) {
                            id.appendMatch8(
                                    (uint8_t) TOPIC_VAL__TO__SWITCH_ADAPTER__SWITCH_INSTANCE__OPENFLOW__SET_CONFIG);
                        }
                    };

                    class PACKET_IN : public AbstractFactory {
                    public:
                        PACKET_IN(MessageType& f) : AbstractFactory(f) {
                            id.appendMatch8(
                                    (uint8_t) TOPIC_VAL__TO__SWITCH_ADAPTER__SWITCH_INSTANCE__OPENFLOW__PACKET_IN);
                        }
                    };

                    class FLOW_REMOVED : public AbstractFactory {
                    public:
                        FLOW_REMOVED(MessageType& f) : AbstractFactory(f) {
                            id.appendMatch8(
                                    (uint8_t) TOPIC_VAL__TO__SWITCH_ADAPTER__SWITCH_INSTANCE__OPENFLOW__FLOW_REMOVED);
                        }
                    };

                    class PORT_STATUS : public AbstractFactory {
                    public:
                        PORT_STATUS(MessageType& f) : AbstractFactory(f) {
                            id.appendMatch8(
                                    (uint8_t) TOPIC_VAL__TO__SWITCH_ADAPTER__SWITCH_INSTANCE__OPENFLOW__PORT_STATUS);
                        }
                    };

                    class PACKET_OUT : public AbstractFactory {
                    public:
                        PACKET_OUT(MessageType& f) : AbstractFactory(f) {
                            id.appendMatch8(
                                    (uint8_t) TOPIC_VAL__TO__SWITCH_ADAPTER__SWITCH_INSTANCE__OPENFLOW__PACKET_OUT);
                        }
                    };

                    class FLOW_MOD : public AbstractFactory {
                    public:
                        FLOW_MOD(MessageType& f) : AbstractFactory(f) {
                            id.appendMatch8(
                                    (uint8_t) TOPIC_VAL__TO__SWITCH_ADAPTER__SWITCH_INSTANCE__OPENFLOW__FLOW_MOD);
                        }
                    };

                    class OF_1_0_PORT_MOD_OF_1_3_GROUP_MOD : public AbstractFactory {
                    public:
                        OF_1_0_PORT_MOD_OF_1_3_GROUP_MOD(MessageType& f) : AbstractFactory(f) {
                            id.appendMatch8(
                                    (uint8_t) TOPIC_VAL__TO__SWITCH_ADAPTER__SWITCH_INSTANCE__OPENFLOW__OF_1_0_PORT_MOD_OF_1_3_GROUP_MOD);
                        }
                    };

                    class OF_1_0_STATS_REQUEST_OF_1_3_PORT_MOD : public AbstractFactory {
                    public:
                        OF_1_0_STATS_REQUEST_OF_1_3_PORT_MOD(MessageType& f) : AbstractFactory(f) {
                            id.appendMatch8(
                                    (uint8_t) TOPIC_VAL__TO__SWITCH_ADAPTER__SWITCH_INSTANCE__OPENFLOW__OF_1_0_STATS_REQUEST_OF_1_3_PORT_MOD);
                        }
                    };

                    class OF_1_0_STATS_REPLY_OF_1_3_TABLE_MOD : public AbstractFactory {
                    public:
                        OF_1_0_STATS_REPLY_OF_1_3_TABLE_MOD(MessageType& f) : AbstractFactory(f) {
                            id.appendMatch8(
                                    (uint8_t) TOPIC_VAL__TO__SWITCH_ADAPTER__SWITCH_INSTANCE__OPENFLOW__OF_1_0_STATS_REPLY_OF_1_3_TABLE_MOD);
                        }
                    };

                    class OF_1_0_BARRIER_REQUEST_OF_1_3_MULTIPART_REQUEST : public AbstractFactory {
                    public:
                        OF_1_0_BARRIER_REQUEST_OF_1_3_MULTIPART_REQUEST(MessageType& f) : AbstractFactory(f) {
                            id.appendMatch8(
                                    (uint8_t) TOPIC_VAL__TO__SWITCH_ADAPTER__SWITCH_INSTANCE__OPENFLOW__OF_1_0_BARRIER_REQUEST_OF_1_3_MULTIPART_REQUEST);
                        }
                    };

                    class OF_1_0_BARRIER_REPLY_OF_1_3_MULTIPART_REPLY : public AbstractFactory {
                    public:
                        OF_1_0_BARRIER_REPLY_OF_1_3_MULTIPART_REPLY(MessageType& f) : AbstractFactory(f) {
                            id.appendMatch8(
                                    (uint8_t) TOPIC_VAL__TO__SWITCH_ADAPTER__SWITCH_INSTANCE__OPENFLOW__OF_1_0_BARRIER_REPLY_OF_1_3_MULTIPART_REPLY);
                        }
                    };

                    class OF_1_0_QUEUE_GET_CONFIG_REQUEST_OF_1_3_BARRIER_REQUEST : public AbstractFactory {
                    public:
                        OF_1_0_QUEUE_GET_CONFIG_REQUEST_OF_1_3_BARRIER_REQUEST(MessageType& f) : AbstractFactory(f) {
                            id.appendMatch8(
                                    (uint8_t) TOPIC_VAL__TO__SWITCH_ADAPTER__SWITCH_INSTANCE__OPENFLOW__OF_1_0_QUEUE_GET_CONFIG_REQUEST_OF_1_3_BARRIER_REQUEST);
                        }
                    };

                    class OF_1_0_QUEUE_GET_CONFIG_REPLY_OF_1_3_BARRIER_REPLY : public AbstractFactory {
                    public:
                        OF_1_0_QUEUE_GET_CONFIG_REPLY_OF_1_3_BARRIER_REPLY(MessageType& f) : AbstractFactory(f) {
                            id.appendMatch8(
                                    (uint8_t) TOPIC_VAL__TO__SWITCH_ADAPTER__SWITCH_INSTANCE__OPENFLOW__OF_1_0_QUEUE_GET_CONFIG_REPLY_OF_1_3_BARRIER_REPLY);
                        }
                    };

                    class OF_1_3_QUEUE_GET_CONFIG_REQUEST : public AbstractFactory {
                    public:
                        OF_1_3_QUEUE_GET_CONFIG_REQUEST(MessageType& f) : AbstractFactory(f) {
                            id.appendMatch8(
                                    (uint8_t) TOPIC_VAL__TO__SWITCH_ADAPTER__SWITCH_INSTANCE__OPENFLOW__OF_1_3_QUEUE_GET_CONFIG_REQUEST);
                        }
                    };

                    class OF_1_3_QUEUE_GET_CONFIG_REPLY : public AbstractFactory {
                    public:
                        OF_1_3_QUEUE_GET_CONFIG_REPLY(MessageType& f) : AbstractFactory(f) {
                            id.appendMatch8(
                                    (uint8_t) TOPIC_VAL__TO__SWITCH_ADAPTER__SWITCH_INSTANCE__OPENFLOW__OF_1_3_QUEUE_GET_CONFIG_REPLY);
                        }
                    };

                    class ROLE_RQUEST : public AbstractFactory {
                    public:
                        ROLE_RQUEST(MessageType& f) : AbstractFactory(f) {
                            id.appendMatch8(
                                    (uint8_t) TOPIC_VAL__TO__SWITCH_ADAPTER__SWITCH_INSTANCE__OPENFLOW__ROLE_RQUEST);
                        }
                    };

                    class ROLE_REPLY : public AbstractFactory {
                    public:
                        ROLE_REPLY(MessageType& f) : AbstractFactory(f) {
                            id.appendMatch8(
                                    (uint8_t) TOPIC_VAL__TO__SWITCH_ADAPTER__SWITCH_INSTANCE__OPENFLOW__ROLE_REPLY);
                        }
                    };

                    class GET_ASYNC_REQUEST : public AbstractFactory {
                    public:
                        GET_ASYNC_REQUEST(MessageType& f) : AbstractFactory(f) {
                            id.appendMatch8(
                                    (uint8_t) TOPIC_VAL__TO__SWITCH_ADAPTER__SWITCH_INSTANCE__OPENFLOW__GET_ASYNC_REQUEST);
                        }
                    };

                    class GET_ASYNC_REPLY : public AbstractFactory {
                    public:
                        GET_ASYNC_REPLY(MessageType& f) : AbstractFactory(f) {
                            id.appendMatch8(
                                    (uint8_t) TOPIC_VAL__TO__SWITCH_ADAPTER__SWITCH_INSTANCE__OPENFLOW__GET_ASYNC_REPLY);
                        }
                    };

                    class SET_ASYNC : public AbstractFactory {
                    public:
                        SET_ASYNC(MessageType& f) : AbstractFactory(f) {
                            id.appendMatch8(
                                    (uint8_t) TOPIC_VAL__TO__SWITCH_ADAPTER__SWITCH_INSTANCE__OPENFLOW__SET_ASYNC);
                        }
                    };

                    class METER_MOD : public AbstractFactory {
                    public:
                        METER_MOD(MessageType& f) : AbstractFactory(f) {
                            id.appendMatch8(
                                    (uint8_t) TOPIC_VAL__TO__SWITCH_ADAPTER__SWITCH_INSTANCE__OPENFLOW__METER_MOD);
                        }
                    };

                    class CUSTOM_OPENFLOWTYPE : public AbstractFactory {
                    public:
                        CUSTOM_OPENFLOWTYPE(MessageType& f, uint8_t value) : AbstractFactory(f) {
                            id.appendMatch8((uint8_t) value);
                        }
                    };
                    ...
                    OF_1_0_VENDOR_OF_1_3_EXPERIMENTER of_1_0_vendor_of_1_3_experimenter() {
                        return OF_1_0_VENDOR_OF_1_3_EXPERIMENTER(id);
                    }
                    ...
                    OF_1_0_PORT_MOD_OF_1_3_GROUP_MOD of_1_0_port_mod_of_1_3_group_mod() {
                        return OF_1_0_PORT_MOD_OF_1_3_GROUP_MOD(id);
                    }

                    OF_1_0_STATS_REQUEST_OF_1_3_PORT_MOD of_1_0_stats_request_of_1_3_port_mod() {
                        return OF_1_0_STATS_REQUEST_OF_1_3_PORT_MOD(id);
                    }

                    OF_1_0_STATS_REPLY_OF_1_3_TABLE_MOD of_1_0_stats_reply_of_1_3_table_mod() {
                        return OF_1_0_STATS_REPLY_OF_1_3_TABLE_MOD(id);
                    }

                    OF_1_0_BARRIER_REQUEST_OF_1_3_MULTIPART_REQUEST of_1_0_barrier_request_of_1_3_multipart_request() {
                        return OF_1_0_BARRIER_REQUEST_OF_1_3_MULTIPART_REQUEST(id);
                    }

                    OF_1_0_BARRIER_REPLY_OF_1_3_MULTIPART_REPLY of_1_0_barrier_reply_of_1_3_multipart_reply() {
                        return OF_1_0_BARRIER_REPLY_OF_1_3_MULTIPART_REPLY(id);
                    }

                    OF_1_0_QUEUE_GET_CONFIG_REQUEST_OF_1_3_BARRIER_REQUEST of_1_0_queue_get_config_request_of_1_3_barrier_request() {
                        return OF_1_0_QUEUE_GET_CONFIG_REQUEST_OF_1_3_BARRIER_REQUEST(id);
                    }

                    OF_1_0_QUEUE_GET_CONFIG_REPLY_OF_1_3_BARRIER_REPLY of_1_0_queue_get_config_reply_of_1_3_barrier_reply() {
                        return OF_1_0_QUEUE_GET_CONFIG_REPLY_OF_1_3_BARRIER_REPLY(id);
                    }

                    OF_1_3_QUEUE_GET_CONFIG_REQUEST of_1_3_queue_get_config_request() {
                        return OF_1_3_QUEUE_GET_CONFIG_REQUEST(id);
                    }

                    OF_1_3_QUEUE_GET_CONFIG_REPLY of_1_3_queue_get_config_reply() {
                        return OF_1_3_QUEUE_GET_CONFIG_REPLY(id);
                    }
    ...
    public:
        ...
        public:
            SWITCH_ADAPTER(MessageType& f) : AbstractFactory(f) {
                id.appendMatch16((uint16_t) TOPIC_VAL__FROM__SWITCH_ADAPTER);
            }

            class OPENFLOW : public AbstractFactory {
            public:
                OPENFLOW(MessageType& f) : AbstractFactory(f) {
                    id.appendMatch8((uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW);
                }

                class HELLO : public AbstractFactory {
                public:
                    HELLO(MessageType& f) : AbstractFactory(f) {
                        id.appendMatch8((uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__HELLO);
                    }
                };
                ...
                public:
                    ERROR(MessageType& f) : AbstractFactory(f) {
                        id.appendMatch8((uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__ERROR);
                    }
                };
                ...
                public:
                    ECHO_REQUEST(MessageType& f) : AbstractFactory(f) {
                        id.appendMatch8((uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__ECHO_REQUEST);
                    }
                };
                ...
                public:
                    ECHO_REPLY(MessageType& f) : AbstractFactory(f) {
                        id.appendMatch8((uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__ECHO_REPLY);
                    }
                };
                ...
                public:
                    OF_1_0_VENDOR_OF_1_3_EXPERIMENTER(MessageType& f) : AbstractFactory(f) {
                        id.appendMatch8(
                                (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__OF_1_0_VENDOR_OF_1_3_EXPERIMENTER);
                    }
                };
                ...
                public:
                    FEATURES_REQUEST(MessageType& f) : AbstractFactory(f) {
                        id.appendMatch8((uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__FEATURES_REQUEST);
                    }
                };
                ...
                public:
                    FEATURES_REPLY(MessageType& f) : AbstractFactory(f) {
                        id.appendMatch8((uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__FEATURES_REPLY);
                    }
                };
                ...
                public:
                    GET_CONFIG_REQUEST(MessageType& f) : AbstractFactory(f) {
                        id.appendMatch8((uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__GET_CONFIG_REQUEST);
                    }
                };
                ...
                public:
                    GET_CONFIG_REPLY(MessageType& f) : AbstractFactory(f) {
                        id.appendMatch8((uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__GET_CONFIG_REPLY);
                    }
                };
                ...
                public:
                    SET_CONFIG(MessageType& f) : AbstractFactory(f) {
                        id.appendMatch8((uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__SET_CONFIG);
                    }
                };
                ...
                public:
                    PACKET_IN(MessageType& f) : AbstractFactory(f) {
                        id.appendMatch8((uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN);
                    }

                    class MULTICAST_GROUP : public AbstractFactory {
                    public:
                        MULTICAST_GROUP(MessageType& f, uint8_t value) : AbstractFactory(f) {
                            id.appendMatch8((uint8_t) value);
                        }

                        class IPV4 : public AbstractFactory {
                        public:
                            IPV4(MessageType& f) : AbstractFactory(f) {
                                id.appendMatch16(
                                        (uint16_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4);
                            }

                            class HOPOPT : public AbstractFactory {
                            public:
                                HOPOPT(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__HOPOPT);
                                }
                            };

                            class ICMP : public AbstractFactory {
                            public:
                                ICMP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__ICMP);
                                }
                            };

                            class IGMP : public AbstractFactory {
                            public:
                                IGMP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__IGMP);
                                }
                            };

                            class GGP : public AbstractFactory {
                            public:
                                GGP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__GGP);
                                }
                            };

                            class IP_IN_IP : public AbstractFactory {
                            public:
                                IP_IN_IP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__IP_IN_IP);
                                }
                            };

                            class ST : public AbstractFactory {
                            public:
                                ST(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__ST);
                                }
                            };

                            class TCP : public AbstractFactory {
                            public:
                                TCP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__TCP);
                                }
                            };

                            class CBT : public AbstractFactory {
                            public:
                                CBT(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__CBT);
                                }
                            };

                            class EGP : public AbstractFactory {
                            public:
                                EGP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__EGP);
                                }
                            };

                            class IGP : public AbstractFactory {
                            public:
                                IGP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__IGP);
                                }
                            };

                            class BBN_RCC_MON : public AbstractFactory {
                            public:
                                BBN_RCC_MON(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__BBN_RCC_MON);
                                }
                            };

                            class NVP_II : public AbstractFactory {
                            public:
                                NVP_II(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__NVP_II);
                                }
                            };

                            class PUP : public AbstractFactory {
                            public:
                                PUP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__PUP);
                                }
                            };

                            class ARGUS : public AbstractFactory {
                            public:
                                ARGUS(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__ARGUS);
                                }
                            };

                            class EMCON : public AbstractFactory {
                            public:
                                EMCON(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__EMCON);
                                }
                            };

                            class XNET : public AbstractFactory {
                            public:
                                XNET(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__XNET);
                                }
                            };

                            class CHAOS : public AbstractFactory {
                            public:
                                CHAOS(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__CHAOS);
                                }
                            };

                            class UDP : public AbstractFactory {
                            public:
                                UDP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__UDP);
                                }

                                class SWITCH_INSTANCE : public AbstractFactory {
                                public:
                                    SWITCH_INSTANCE(MessageType& f, uint64_t value) : AbstractFactory(
                                            f) { id.appendMatch64((uint64_t) value); }
                                };
                            ...
                            public:
                                MUX(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__MUX);
                                }
                            };

                            class DCN_MEAS : public AbstractFactory {
                            public:
                                DCN_MEAS(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__DCN_MEAS);
                                }
                            };

                            class HMP : public AbstractFactory {
                            public:
                                HMP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__HMP);
                                }
                            };

                            class PRM : public AbstractFactory {
                            public:
                                PRM(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__PRM);
                                }
                            };

                            class XNS_IDP : public AbstractFactory {
                            public:
                                XNS_IDP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__XNS_IDP);
                                }
                            };

                            class TRUNK_1 : public AbstractFactory {
                            public:
                                TRUNK_1(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__TRUNK_1);
                                }
                            };

                            class TRUNK_2 : public AbstractFactory {
                            public:
                                TRUNK_2(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__TRUNK_2);
                                }
                            };

                            class LEAF_1 : public AbstractFactory {
                            public:
                                LEAF_1(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__LEAF_1);
                                }
                            };

                            class LEAF_2 : public AbstractFactory {
                            public:
                                LEAF_2(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__LEAF_2);
                                }
                            };

                            class RDP : public AbstractFactory {
                            public:
                                RDP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__RDP);
                                }
                            };

                            class IRTP : public AbstractFactory {
                            public:
                                IRTP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__IRTP);
                                }
                            };

                            class ISO_TP4 : public AbstractFactory {
                            public:
                                ISO_TP4(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__ISO_TP4);
                                }
                            };

                            class NETBLT : public AbstractFactory {
                            public:
                                NETBLT(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__NETBLT);
                                }
                            };

                            class MFE_NSP : public AbstractFactory {
                            public:
                                MFE_NSP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__MFE_NSP);
                                }
                            };

                            class MERIT_INP : public AbstractFactory {
                            public:
                                MERIT_INP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__MERIT_INP);
                                }
                            };

                            class DCCP : public AbstractFactory {
                            public:
                                DCCP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__DCCP);
                                }
                            };

                            class _3PC : public AbstractFactory {
                            public:
                                _3PC(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4___3PC);
                                }
                            };

                            class IDPR : public AbstractFactory {
                            public:
                                IDPR(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__IDPR);
                                }
                            };

                            class XTP : public AbstractFactory {
                            public:
                                XTP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__XTP);
                                }
                            };

                            class DDP : public AbstractFactory {
                            public:
                                DDP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__DDP);
                                }
                            };

                            class IDPR_CMTP : public AbstractFactory {
                            public:
                                IDPR_CMTP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__IDPR_CMTP);
                                }
                            };

                            class TPPP : public AbstractFactory {
                            public:
                                TPPP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__TPPP);
                                }
                            };

                            class IL : public AbstractFactory {
                            public:
                                IL(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__IL);
                                }
                            };

                            class IPV6_ENCAP : public AbstractFactory {
                            public:
                                IPV6_ENCAP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__IPV6_ENCAP);
                                }
                            };

                            class SDRP : public AbstractFactory {
                            public:
                                SDRP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__SDRP);
                                }
                            };

                            class IPV6_ROUTE : public AbstractFactory {
                            public:
                                IPV6_ROUTE(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__IPV6_ROUTE);
                                }
                            };

                            class IPV6_FRAG : public AbstractFactory {
                            public:
                                IPV6_FRAG(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__IPV6_FRAG);
                                }
                            };

                            class IDRP : public AbstractFactory {
                            public:
                                IDRP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__IDRP);
                                }
                            };

                            class RSVP : public AbstractFactory {
                            public:
                                RSVP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__RSVP);
                                }
                            };

                            class GRE : public AbstractFactory {
                            public:
                                GRE(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__GRE);
                                }
                            };

                            class MHRP : public AbstractFactory {
                            public:
                                MHRP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__MHRP);
                                }
                            };

                            class BNA : public AbstractFactory {
                            public:
                                BNA(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__BNA);
                                }
                            };

                            class ESP : public AbstractFactory {
                            public:
                                ESP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__ESP);
                                }
                            };

                            class AH : public AbstractFactory {
                            public:
                                AH(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__AH);
                                }
                            };

                            class I_NLSP : public AbstractFactory {
                            public:
                                I_NLSP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__I_NLSP);
                                }
                            };

                            class SWIPE : public AbstractFactory {
                            public:
                                SWIPE(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__SWIPE);
                                }
                            };

                            class NARP : public AbstractFactory {
                            public:
                                NARP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__NARP);
                                }
                            };

                            class MOBILE : public AbstractFactory {
                            public:
                                MOBILE(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__MOBILE);
                                }
                            };

                            class TLSP : public AbstractFactory {
                            public:
                                TLSP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__TLSP);
                                }
                            };

                            class SKIP : public AbstractFactory {
                            public:
                                SKIP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__SKIP);
                                }
                            };

                            class IPV6_ICMP : public AbstractFactory {
                            public:
                                IPV6_ICMP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__IPV6_ICMP);
                                }
                            };

                            class IPV6_NONXT : public AbstractFactory {
                            public:
                                IPV6_NONXT(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__IPV6_NONXT);
                                }
                            };

                            class IPV6_OPTS : public AbstractFactory {
                            public:
                                IPV6_OPTS(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__IPV6_OPTS);
                                }
                            };

                            class ANY_HOST_INTERNAL_PROTOCOL : public AbstractFactory {
                            public:
                                ANY_HOST_INTERNAL_PROTOCOL(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__ANY_HOST_INTERNAL_PROTOCOL);
                                }
                            };

                            class CFTP : public AbstractFactory {
                            public:
                                CFTP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__CFTP);
                                }
                            };

                            class ANY_LOCAL_NETWORK : public AbstractFactory {
                            public:
                                ANY_LOCAL_NETWORK(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__ANY_LOCAL_NETWORK);
                                }
                            };

                            class SAT_EXPAK : public AbstractFactory {
                            public:
                                SAT_EXPAK(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__SAT_EXPAK);
                                }
                            };

                            class KRYPTOLAN : public AbstractFactory {
                            public:
                                KRYPTOLAN(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__KRYPTOLAN);
                                }
                            };

                            class RVD : public AbstractFactory {
                            public:
                                RVD(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__RVD);
                                }
                            };

                            class IPPC : public AbstractFactory {
                            public:
                                IPPC(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__IPPC);
                                }
                            };

                            class ANY_DISTRIBUTED_FILE_SYSTEM : public AbstractFactory {
                            public:
                                ANY_DISTRIBUTED_FILE_SYSTEM(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__ANY_DISTRIBUTED_FILE_SYSTEM);
                                }
                            };

                            class SAT_MON : public AbstractFactory {
                            public:
                                SAT_MON(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__SAT_MON);
                                }
                            };

                            class VISA : public AbstractFactory {
                            public:
                                VISA(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__VISA);
                                }
                            };

                            class IPCU : public AbstractFactory {
                            public:
                                IPCU(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__IPCU);
                                }
                            };

                            class CPNX : public AbstractFactory {
                            public:
                                CPNX(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__CPNX);
                                }
                            };

                            class CPHB : public AbstractFactory {
                            public:
                                CPHB(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__CPHB);
                                }
                            };

                            class WSN : public AbstractFactory {
                            public:
                                WSN(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__WSN);
                                }
                            };

                            class PVP : public AbstractFactory {
                            public:
                                PVP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__PVP);
                                }
                            };

                            class BR_SAT_MON : public AbstractFactory {
                            public:
                                BR_SAT_MON(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__BR_SAT_MON);
                                }
                            };

                            class SUN_ND : public AbstractFactory {
                            public:
                                SUN_ND(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__SUN_ND);
                                }
                            };

                            class WB_MON : public AbstractFactory {
                            public:
                                WB_MON(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__WB_MON);
                                }
                            };

                            class WB_EXPAK : public AbstractFactory {
                            public:
                                WB_EXPAK(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__WB_EXPAK);
                                }
                            };

                            class ISO_IP : public AbstractFactory {
                            public:
                                ISO_IP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__ISO_IP);
                                }
                            };

                            class VMTP : public AbstractFactory {
                            public:
                                VMTP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__VMTP);
                                }
                            };

                            class SECURE_VMTP : public AbstractFactory {
                            public:
                                SECURE_VMTP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__SECURE_VMTP);
                                }
                            };

                            class VINES : public AbstractFactory {
                            public:
                                VINES(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__VINES);
                                }
                            };

                            class TTP : public AbstractFactory {
                            public:
                                TTP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__TTP);
                                }
                            };

                            class IPTM : public AbstractFactory {
                            public:
                                IPTM(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__IPTM);
                                }
                            };

                            class NSFNET_IGP : public AbstractFactory {
                            public:
                                NSFNET_IGP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__NSFNET_IGP);
                                }
                            };

                            class DGP : public AbstractFactory {
                            public:
                                DGP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__DGP);
                                }
                            };

                            class TCF : public AbstractFactory {
                            public:
                                TCF(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__TCF);
                                }
                            };

                            class EIGRP : public AbstractFactory {
                            public:
                                EIGRP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__EIGRP);
                                }
                            };

                            class OSPF : public AbstractFactory {
                            public:
                                OSPF(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__OSPF);
                                }
                            };

                            class SPRITE_RPC : public AbstractFactory {
                            public:
                                SPRITE_RPC(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__SPRITE_RPC);
                                }
                            };

                            class LARP : public AbstractFactory {
                            public:
                                LARP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__LARP);
                                }
                            };

                            class MTP : public AbstractFactory {
                            public:
                                MTP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__MTP);
                                }
                            };

                            class AX_25 : public AbstractFactory {
                            public:
                                AX_25(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__AX_25);
                                }
                            };

                            class IPIP : public AbstractFactory {
                            public:
                                IPIP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__IPIP);
                                }
                            };

                            class MICP : public AbstractFactory {
                            public:
                                MICP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__MICP);
                                }
                            };

                            class SCC_SP : public AbstractFactory {
                            public:
                                SCC_SP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__SCC_SP);
                                }
                            };

                            class ETHERIP : public AbstractFactory {
                            public:
                                ETHERIP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__ETHERIP);
                                }
                            };

                            class ENCAP : public AbstractFactory {
                            public:
                                ENCAP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__ENCAP);
                                }
                            };

                            class ANY_PRIVATE_ENCRYPTION_SCHEME : public AbstractFactory {
                            public:
                                ANY_PRIVATE_ENCRYPTION_SCHEME(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__ANY_PRIVATE_ENCRYPTION_SCHEME);
                                }
                            };

                            class GMTP : public AbstractFactory {
                            public:
                                GMTP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__GMTP);
                                }
                            };

                            class IFMP : public AbstractFactory {
                            public:
                                IFMP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__IFMP);
                                }
                            };

                            class PNNI : public AbstractFactory {
                            public:
                                PNNI(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__PNNI);
                                }
                            };

                            class PIM : public AbstractFactory {
                            public:
                                PIM(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__PIM);
                                }
                            };

                            class ARIS : public AbstractFactory {
                            public:
                                ARIS(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__ARIS);
                                }
                            };

                            class SCPS : public AbstractFactory {
                            public:
                                SCPS(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__SCPS);
                                }
                            };

                            class QNX : public AbstractFactory {
                            public:
                                QNX(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__QNX);
                                }
                            };

                            class A_N : public AbstractFactory {
                            public:
                                A_N(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__A_N);
                                }
                            };

                            class IPCOMP : public AbstractFactory {
                            public:
                                IPCOMP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__IPCOMP);
                                }
                            };

                            class SNP : public AbstractFactory {
                            public:
                                SNP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__SNP);
                                }
                            };

                            class COMPAQ_PEER : public AbstractFactory {
                            public:
                                COMPAQ_PEER(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__COMPAQ_PEER);
                                }
                            };

                            class IPX_IN_IP : public AbstractFactory {
                            public:
                                IPX_IN_IP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__IPX_IN_IP);
                                }
                            };

                            class VRRP : public AbstractFactory {
                            public:
                                VRRP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__VRRP);
                                }
                            };

                            class PGM : public AbstractFactory {
                            public:
                                PGM(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__PGM);
                                }
                            };

                            class ANY_0_HOP_PROTOCOL : public AbstractFactory {
                            public:
                                ANY_0_HOP_PROTOCOL(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__ANY_0_HOP_PROTOCOL);
                                }
                            };

                            class L2TP : public AbstractFactory {
                            public:
                                L2TP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__L2TP);
                                }
                            };

                            class DDX : public AbstractFactory {
                            public:
                                DDX(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__DDX);
                                }
                            };

                            class IATP : public AbstractFactory {
                            public:
                                IATP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__IATP);
                                }
                            };

                            class STP : public AbstractFactory {
                            public:
                                STP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__STP);
                                }
                            };

                            class SRP : public AbstractFactory {
                            public:
                                SRP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__SRP);
                                }
                            };

                            class UTI : public AbstractFactory {
                            public:
                                UTI(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__UTI);
                                }
                            };

                            class SMP : public AbstractFactory {
                            public:
                                SMP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__SMP);
                                }
                            };

                            class SM : public AbstractFactory {
                            public:
                                SM(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__SM);
                                }
                            };

                            class PTP : public AbstractFactory {
                            public:
                                PTP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__PTP);
                                }
                            };

                            class IS_IS_OVER_IPV4 : public AbstractFactory {
                            public:
                                IS_IS_OVER_IPV4(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__IS_IS_OVER_IPV4);
                                }
                            };

                            class FIRE : public AbstractFactory {
                            public:
                                FIRE(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__FIRE);
                                }
                            };

                            class CRTP : public AbstractFactory {
                            public:
                                CRTP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__CRTP);
                                }
                            };

                            class CRUDP : public AbstractFactory {
                            public:
                                CRUDP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__CRUDP);
                                }
                            };

                            class SSCOPMCE : public AbstractFactory {
                            public:
                                SSCOPMCE(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__SSCOPMCE);
                                }
                            };

                            class IPLT : public AbstractFactory {
                            public:
                                IPLT(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__IPLT);
                                }
                            };

                            class SPS : public AbstractFactory {
                            public:
                                SPS(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__SPS);
                                }
                            };

                            class PIPE : public AbstractFactory {
                            public:
                                PIPE(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__PIPE);
                                }
                            };

                            class SCTP : public AbstractFactory {
                            public:
                                SCTP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__SCTP);
                                }
                            };

                            class FC : public AbstractFactory {
                            public:
                                FC(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__FC);
                                }
                            };

                            class RSVP_E2E_IGNORE : public AbstractFactory {
                            public:
                                RSVP_E2E_IGNORE(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__RSVP_E2E_IGNORE);
                                }
                            };

                            class MOBILITY_HEADER : public AbstractFactory {
                            public:
                                MOBILITY_HEADER(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__MOBILITY_HEADER);
                                }
                            };

                            class UDPLITE : public AbstractFactory {
                            public:
                                UDPLITE(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__UDPLITE);
                                }
                            };

                            class MPLS_IN_IP : public AbstractFactory {
                            public:
                                MPLS_IN_IP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__MPLS_IN_IP);
                                }
                            };

                            class MANET : public AbstractFactory {
                            public:
                                MANET(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__MANET);
                                }
                            };

                            class HIP : public AbstractFactory {
                            public:
                                HIP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__HIP);
                                }
                            };

                            class SHIM6 : public AbstractFactory {
                            public:
                                SHIM6(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__SHIM6);
                                }
                            };

                            class WESP : public AbstractFactory {
                            public:
                                WESP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__WESP);
                                }
                            };

                            class ROHC : public AbstractFactory {
                            public:
                                ROHC(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__ROHC);
                                }
                            };

                            class USE_FOR_EXPERIMENTATION_AND_TESTING_0XFD : public AbstractFactory {
                            public:
                                USE_FOR_EXPERIMENTATION_AND_TESTING_0XFD(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__USE_FOR_EXPERIMENTATION_AND_TESTING_0XFD);
                                }
                            };

                            class USE_FOR_EXPERIMENTATION_AND_TESTING_0XFE : public AbstractFactory {
                            public:
                                USE_FOR_EXPERIMENTATION_AND_TESTING_0XFE(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__USE_FOR_EXPERIMENTATION_AND_TESTING_0XFE);
                                }
                            };

                            class RESERVED : public AbstractFactory {
                            public:
                                RESERVED(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV4__RESERVED);
                                }
                            };

                            class CUSTOM : public AbstractFactory {
                            public:
                                CUSTOM(MessageType& f, uint8_t value) : AbstractFactory(f) {
                                    id.appendMatch8((uint8_t) value);
                                }
                            };
                            ...
                            ANY_HOST_INTERNAL_PROTOCOL any_host_internal_protocol() {
                                return ANY_HOST_INTERNAL_PROTOCOL(id);
                            }
                            ...
                            ANY_DISTRIBUTED_FILE_SYSTEM any_distributed_file_system() {
                                return ANY_DISTRIBUTED_FILE_SYSTEM(id);
                            }
                            ...
                            ANY_PRIVATE_ENCRYPTION_SCHEME any_private_encryption_scheme() {
                                return ANY_PRIVATE_ENCRYPTION_SCHEME(id);
                            }
                            ...
                            USE_FOR_EXPERIMENTATION_AND_TESTING_0XFD use_for_experimentation_and_testing_0xfd() {
                                return USE_FOR_EXPERIMENTATION_AND_TESTING_0XFD(id);
                            }

                            USE_FOR_EXPERIMENTATION_AND_TESTING_0XFE use_for_experimentation_and_testing_0xfe() {
                                return USE_FOR_EXPERIMENTATION_AND_TESTING_0XFE(id);
                            }
                        ...
                        public:
                            ARP(MessageType& f) : AbstractFactory(f) {
                                id.appendMatch16(
                                        (uint16_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__ARP);
                            }
                        };

                        class WAKE_ON_LAN : public AbstractFactory {
                        public:
                            WAKE_ON_LAN(MessageType& f) : AbstractFactory(f) {
                                id.appendMatch16(
                                        (uint16_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__WAKE_ON_LAN);
                            }
                        };

                        class AUDIO_VIDEO_TRANSPORT_PROTOCOL_AS_DEFINED_IN_IEEE_STD_1722_2011 : public AbstractFactory {
                        public:
                            AUDIO_VIDEO_TRANSPORT_PROTOCOL_AS_DEFINED_IN_IEEE_STD_1722_2011(MessageType& f)
                                    : AbstractFactory(f) {
                                id.appendMatch16(
                                        (uint16_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__AUDIO_VIDEO_TRANSPORT_PROTOCOL_AS_DEFINED_IN_IEEE_STD_1722_2011);
                            }
                        };

                        class IETF_TRILL_PROTOCOL : public AbstractFactory {
                        public:
                            IETF_TRILL_PROTOCOL(MessageType& f) : AbstractFactory(f) {
                                id.appendMatch16(
                                        (uint16_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IETF_TRILL_PROTOCOL);
                            }
                        };

                        class DECNET_PHASE_IV : public AbstractFactory {
                        public:
                            DECNET_PHASE_IV(MessageType& f) : AbstractFactory(f) {
                                id.appendMatch16(
                                        (uint16_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__DECNET_PHASE_IV);
                            }
                        };

                        class REVERSE_ADDRESS_RESOLUTION_PROTOCOL : public AbstractFactory {
                        public:
                            REVERSE_ADDRESS_RESOLUTION_PROTOCOL(MessageType& f) : AbstractFactory(f) {
                                id.appendMatch16(
                                        (uint16_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__REVERSE_ADDRESS_RESOLUTION_PROTOCOL);
                            }
                        };

                        class APPLETALK_ETHERTALK : public AbstractFactory {
                        public:
                            APPLETALK_ETHERTALK(MessageType& f) : AbstractFactory(f) {
                                id.appendMatch16(
                                        (uint16_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__APPLETALK_ETHERTALK);
                            }
                        };

                        class APPLETALK_ADDRESS_RESOLUTION_PROTOCOL_AARP : public AbstractFactory {
                        public:
                            APPLETALK_ADDRESS_RESOLUTION_PROTOCOL_AARP(MessageType& f) : AbstractFactory(f) {
                                id.appendMatch16(
                                        (uint16_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__APPLETALK_ADDRESS_RESOLUTION_PROTOCOL_AARP);
                            }
                        };

                        class VLAN_TAGGED_FRAME_IEEE_802_1Q_SHORTEST_PATH_BRIDGING_IEEE_802_1AQ
                                : public AbstractFactory {
                        public:
                            VLAN_TAGGED_FRAME_IEEE_802_1Q_SHORTEST_PATH_BRIDGING_IEEE_802_1AQ(MessageType& f)
                                    : AbstractFactory(f) {
                                id.appendMatch16(
                                        (uint16_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__VLAN_TAGGED_FRAME_IEEE_802_1Q_SHORTEST_PATH_BRIDGING_IEEE_802_1AQ);
                            }
                        };

                        class IPX_1 : public AbstractFactory {
                        public:
                            IPX_1(MessageType& f) : AbstractFactory(f) {
                                id.appendMatch16(
                                        (uint16_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPX_1);
                            }
                        };

                        class IPX_2 : public AbstractFactory {
                        public:
                            IPX_2(MessageType& f) : AbstractFactory(f) {
                                id.appendMatch16(
                                        (uint16_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPX_2);
                            }
                        };

                        class QNX_QNET : public AbstractFactory {
                        public:
                            QNX_QNET(MessageType& f) : AbstractFactory(f) {
                                id.appendMatch16(
                                        (uint16_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__QNX_QNET);
                            }
                        };

                        class IPV6 : public AbstractFactory {
                        public:
                            IPV6(MessageType& f) : AbstractFactory(f) {
                                id.appendMatch16(
                                        (uint16_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6);
                            }
                            ...
                            public:
                                HOPOPT(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__HOPOPT);
                                }
                            };
                            ...
                            public:
                                ICMP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__ICMP);
                                }
                            };
                            ...
                            public:
                                IGMP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__IGMP);
                                }
                            };
                            ...
                            public:
                                GGP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__GGP);
                                }
                            };
                            ...
                            public:
                                IP_IN_IP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__IP_IN_IP);
                                }
                            };
                            ...
                            public:
                                ST(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__ST);
                                }
                            };
                            ...
                            public:
                                TCP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__TCP);
                                }
                            };
                            ...
                            public:
                                CBT(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__CBT);
                                }
                            };
                            ...
                            public:
                                EGP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__EGP);
                                }
                            };
                            ...
                            public:
                                IGP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__IGP);
                                }
                            };
                            ...
                            public:
                                BBN_RCC_MON(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__BBN_RCC_MON);
                                }
                            };
                            ...
                            public:
                                NVP_II(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__NVP_II);
                                }
                            };
                            ...
                            public:
                                PUP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__PUP);
                                }
                            };
                            ...
                            public:
                                ARGUS(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__ARGUS);
                                }
                            };
                            ...
                            public:
                                EMCON(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__EMCON);
                                }
                            };
                            ...
                            public:
                                XNET(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__XNET);
                                }
                            };
                            ...
                            public:
                                CHAOS(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__CHAOS);
                                }
                            };
                            ...
                            public:
                                UDP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__UDP);
                                }
                            };
                            ...
                            public:
                                MUX(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__MUX);
                                }
                            };
                            ...
                            public:
                                DCN_MEAS(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__DCN_MEAS);
                                }
                            };
                            ...
                            public:
                                HMP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__HMP);
                                }
                            };
                            ...
                            public:
                                PRM(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__PRM);
                                }
                            };
                            ...
                            public:
                                XNS_IDP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__XNS_IDP);
                                }
                            };
                            ...
                            public:
                                TRUNK_1(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__TRUNK_1);
                                }
                            };
                            ...
                            public:
                                TRUNK_2(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__TRUNK_2);
                                }
                            };
                            ...
                            public:
                                LEAF_1(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__LEAF_1);
                                }
                            };
                            ...
                            public:
                                LEAF_2(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__LEAF_2);
                                }
                            };
                            ...
                            public:
                                RDP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__RDP);
                                }
                            };
                            ...
                            public:
                                IRTP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__IRTP);
                                }
                            };
                            ...
                            public:
                                ISO_TP4(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__ISO_TP4);
                                }
                            };
                            ...
                            public:
                                NETBLT(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__NETBLT);
                                }
                            };
                            ...
                            public:
                                MFE_NSP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__MFE_NSP);
                                }
                            };
                            ...
                            public:
                                MERIT_INP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__MERIT_INP);
                                }
                            };
                            ...
                            public:
                                DCCP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__DCCP);
                                }
                            };
                            ...
                            public:
                                _3PC(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6___3PC);
                                }
                            };
                            ...
                            public:
                                IDPR(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__IDPR);
                                }
                            };
                            ...
                            public:
                                XTP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__XTP);
                                }
                            };
                            ...
                            public:
                                DDP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__DDP);
                                }
                            };
                            ...
                            public:
                                IDPR_CMTP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__IDPR_CMTP);
                                }
                            };
                            ...
                            public:
                                TPPP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__TPPP);
                                }
                            };
                            ...
                            public:
                                IL(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__IL);
                                }
                            };
                            ...
                            public:
                                IPV6_ENCAP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__IPV6_ENCAP);
                                }
                            };
                            ...
                            public:
                                SDRP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__SDRP);
                                }
                            };
                            ...
                            public:
                                IPV6_ROUTE(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__IPV6_ROUTE);
                                }
                            };
                            ...
                            public:
                                IPV6_FRAG(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__IPV6_FRAG);
                                }
                            };
                            ...
                            public:
                                IDRP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__IDRP);
                                }
                            };
                            ...
                            public:
                                RSVP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__RSVP);
                                }
                            };
                            ...
                            public:
                                GRE(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__GRE);
                                }
                            };
                            ...
                            public:
                                MHRP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__MHRP);
                                }
                            };
                            ...
                            public:
                                BNA(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__BNA);
                                }
                            };
                            ...
                            public:
                                ESP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__ESP);
                                }
                            };
                            ...
                            public:
                                AH(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__AH);
                                }
                            };
                            ...
                            public:
                                I_NLSP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__I_NLSP);
                                }
                            };
                            ...
                            public:
                                SWIPE(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__SWIPE);
                                }
                            };
                            ...
                            public:
                                NARP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__NARP);
                                }
                            };
                            ...
                            public:
                                MOBILE(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__MOBILE);
                                }
                            };
                            ...
                            public:
                                TLSP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__TLSP);
                                }
                            };
                            ...
                            public:
                                SKIP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__SKIP);
                                }
                            };
                            ...
                            public:
                                IPV6_ICMP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__IPV6_ICMP);
                                }
                            };
                            ...
                            public:
                                IPV6_NONXT(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__IPV6_NONXT);
                                }
                            };
                            ...
                            public:
                                IPV6_OPTS(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__IPV6_OPTS);
                                }
                            };
                            ...
                            public:
                                ANY_HOST_INTERNAL_PROTOCOL(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__ANY_HOST_INTERNAL_PROTOCOL);
                                }
                            };
                            ...
                            public:
                                CFTP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__CFTP);
                                }
                            };
                            ...
                            public:
                                ANY_LOCAL_NETWORK(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__ANY_LOCAL_NETWORK);
                                }
                            };
                            ...
                            public:
                                SAT_EXPAK(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__SAT_EXPAK);
                                }
                            };
                            ...
                            public:
                                KRYPTOLAN(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__KRYPTOLAN);
                                }
                            };
                            ...
                            public:
                                RVD(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__RVD);
                                }
                            };
                            ...
                            public:
                                IPPC(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__IPPC);
                                }
                            };
                            ...
                            public:
                                ANY_DISTRIBUTED_FILE_SYSTEM(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__ANY_DISTRIBUTED_FILE_SYSTEM);
                                }
                            };
                            ...
                            public:
                                SAT_MON(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__SAT_MON);
                                }
                            };
                            ...
                            public:
                                VISA(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__VISA);
                                }
                            };
                            ...
                            public:
                                IPCU(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__IPCU);
                                }
                            };
                            ...
                            public:
                                CPNX(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__CPNX);
                                }
                            };
                            ...
                            public:
                                CPHB(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__CPHB);
                                }
                            };
                            ...
                            public:
                                WSN(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__WSN);
                                }
                            };
                            ...
                            public:
                                PVP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__PVP);
                                }
                            };
                            ...
                            public:
                                BR_SAT_MON(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__BR_SAT_MON);
                                }
                            };
                            ...
                            public:
                                SUN_ND(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__SUN_ND);
                                }
                            };
                            ...
                            public:
                                WB_MON(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__WB_MON);
                                }
                            };
                            ...
                            public:
                                WB_EXPAK(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__WB_EXPAK);
                                }
                            };
                            ...
                            public:
                                ISO_IP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__ISO_IP);
                                }
                            };
                            ...
                            public:
                                VMTP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__VMTP);
                                }
                            };
                            ...
                            public:
                                SECURE_VMTP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__SECURE_VMTP);
                                }
                            };
                            ...
                            public:
                                VINES(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__VINES);
                                }
                            };
                            ...
                            public:
                                TTP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__TTP);
                                }
                            };
                            ...
                            public:
                                IPTM(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__IPTM);
                                }
                            };
                            ...
                            public:
                                NSFNET_IGP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__NSFNET_IGP);
                                }
                            };
                            ...
                            public:
                                DGP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__DGP);
                                }
                            };
                            ...
                            public:
                                TCF(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__TCF);
                                }
                            };
                            ...
                            public:
                                EIGRP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__EIGRP);
                                }
                            };
                            ...
                            public:
                                OSPF(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__OSPF);
                                }
                            };
                            ...
                            public:
                                SPRITE_RPC(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__SPRITE_RPC);
                                }
                            };
                            ...
                            public:
                                LARP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__LARP);
                                }
                            };
                            ...
                            public:
                                MTP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__MTP);
                                }
                            };
                            ...
                            public:
                                AX_25(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__AX_25);
                                }
                            };
                            ...
                            public:
                                IPIP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__IPIP);
                                }
                            };
                            ...
                            public:
                                MICP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__MICP);
                                }
                            };
                            ...
                            public:
                                SCC_SP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__SCC_SP);
                                }
                            };
                            ...
                            public:
                                ETHERIP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__ETHERIP);
                                }
                            };
                            ...
                            public:
                                ENCAP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__ENCAP);
                                }
                            };
                            ...
                            public:
                                ANY_PRIVATE_ENCRYPTION_SCHEME(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__ANY_PRIVATE_ENCRYPTION_SCHEME);
                                }
                            };
                            ...
                            public:
                                GMTP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__GMTP);
                                }
                            };
                            ...
                            public:
                                IFMP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__IFMP);
                                }
                            };
                            ...
                            public:
                                PNNI(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__PNNI);
                                }
                            };
                            ...
                            public:
                                PIM(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__PIM);
                                }
                            };
                            ...
                            public:
                                ARIS(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__ARIS);
                                }
                            };
                            ...
                            public:
                                SCPS(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__SCPS);
                                }
                            };
                            ...
                            public:
                                QNX(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__QNX);
                                }
                            };
                            ...
                            public:
                                A_N(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__A_N);
                                }
                            };
                            ...
                            public:
                                IPCOMP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__IPCOMP);
                                }
                            };
                            ...
                            public:
                                SNP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__SNP);
                                }
                            };
                            ...
                            public:
                                COMPAQ_PEER(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__COMPAQ_PEER);
                                }
                            };
                            ...
                            public:
                                IPX_IN_IP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__IPX_IN_IP);
                                }
                            };
                            ...
                            public:
                                VRRP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__VRRP);
                                }
                            };
                            ...
                            public:
                                PGM(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__PGM);
                                }
                            };
                            ...
                            public:
                                ANY_0_HOP_PROTOCOL(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__ANY_0_HOP_PROTOCOL);
                                }
                            };
                            ...
                            public:
                                L2TP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__L2TP);
                                }
                            };
                            ...
                            public:
                                DDX(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__DDX);
                                }
                            };
                            ...
                            public:
                                IATP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__IATP);
                                }
                            };
                            ...
                            public:
                                STP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__STP);
                                }
                            };
                            ...
                            public:
                                SRP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__SRP);
                                }
                            };
                            ...
                            public:
                                UTI(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__UTI);
                                }
                            };
                            ...
                            public:
                                SMP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__SMP);
                                }
                            };
                            ...
                            public:
                                SM(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__SM);
                                }
                            };
                            ...
                            public:
                                PTP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__PTP);
                                }
                            };
                            ...
                            public:
                                IS_IS_OVER_IPV4(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__IS_IS_OVER_IPV4);
                                }
                            };
                            ...
                            public:
                                FIRE(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__FIRE);
                                }
                            };
                            ...
                            public:
                                CRTP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__CRTP);
                                }
                            };
                            ...
                            public:
                                CRUDP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__CRUDP);
                                }
                            };
                            ...
                            public:
                                SSCOPMCE(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__SSCOPMCE);
                                }
                            };
                            ...
                            public:
                                IPLT(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__IPLT);
                                }
                            };
                            ...
                            public:
                                SPS(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__SPS);
                                }
                            };
                            ...
                            public:
                                PIPE(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__PIPE);
                                }
                            };
                            ...
                            public:
                                SCTP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__SCTP);
                                }
                            };
                            ...
                            public:
                                FC(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__FC);
                                }
                            };
                            ...
                            public:
                                RSVP_E2E_IGNORE(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__RSVP_E2E_IGNORE);
                                }
                            };
                            ...
                            public:
                                MOBILITY_HEADER(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__MOBILITY_HEADER);
                                }
                            };
                            ...
                            public:
                                UDPLITE(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__UDPLITE);
                                }
                            };
                            ...
                            public:
                                MPLS_IN_IP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__MPLS_IN_IP);
                                }
                            };
                            ...
                            public:
                                MANET(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__MANET);
                                }
                            };
                            ...
                            public:
                                HIP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__HIP);
                                }
                            };
                            ...
                            public:
                                SHIM6(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__SHIM6);
                                }
                            };
                            ...
                            public:
                                WESP(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__WESP);
                                }
                            };
                            ...
                            public:
                                ROHC(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__ROHC);
                                }
                            };
                            ...
                            public:
                                USE_FOR_EXPERIMENTATION_AND_TESTING_0XFD(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__USE_FOR_EXPERIMENTATION_AND_TESTING_0XFD);
                                }
                            };
                            ...
                            public:
                                USE_FOR_EXPERIMENTATION_AND_TESTING_0XFE(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__USE_FOR_EXPERIMENTATION_AND_TESTING_0XFE);
                                }
                            };
                            ...
                            public:
                                RESERVED(MessageType& f) : AbstractFactory(f) {
                                    id.appendMatch8(
                                            (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IPV6__RESERVED);
                                }
                            };
                        ...
                        public:
                            ETHERNET_FLOW_CONTROL(MessageType& f) : AbstractFactory(f) {
                                id.appendMatch16(
                                        (uint16_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__ETHERNET_FLOW_CONTROL);
                            }
                        };

                        class SLOW_PROTOCOLS_IEEE_802_3 : public AbstractFactory {
                        public:
                            SLOW_PROTOCOLS_IEEE_802_3(MessageType& f) : AbstractFactory(f) {
                                id.appendMatch16(
                                        (uint16_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__SLOW_PROTOCOLS_IEEE_802_3);
                            }
                        };

                        class COBRANET : public AbstractFactory {
                        public:
                            COBRANET(MessageType& f) : AbstractFactory(f) {
                                id.appendMatch16(
                                        (uint16_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__COBRANET);
                            }
                        };

                        class MPLS_UNICAST : public AbstractFactory {
                        public:
                            MPLS_UNICAST(MessageType& f) : AbstractFactory(f) {
                                id.appendMatch16(
                                        (uint16_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__MPLS_UNICAST);
                            }
                        };

                        class MPLS_MULTICAST : public AbstractFactory {
                        public:
                            MPLS_MULTICAST(MessageType& f) : AbstractFactory(f) {
                                id.appendMatch16(
                                        (uint16_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__MPLS_MULTICAST);
                            }
                        };

                        class PPPOE_DISCOVERY_STAGE : public AbstractFactory {
                        public:
                            PPPOE_DISCOVERY_STAGE(MessageType& f) : AbstractFactory(f) {
                                id.appendMatch16(
                                        (uint16_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__PPPOE_DISCOVERY_STAGE);
                            }
                        };

                        class PPPOE_SESSION_STAGE : public AbstractFactory {
                        public:
                            PPPOE_SESSION_STAGE(MessageType& f) : AbstractFactory(f) {
                                id.appendMatch16(
                                        (uint16_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__PPPOE_SESSION_STAGE);
                            }
                        };

                        class JUMBO_FRAMES : public AbstractFactory {
                        public:
                            JUMBO_FRAMES(MessageType& f) : AbstractFactory(f) {
                                id.appendMatch16(
                                        (uint16_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__JUMBO_FRAMES);
                            }
                        };

                        class HOMEPLUG_1_0_MME : public AbstractFactory {
                        public:
                            HOMEPLUG_1_0_MME(MessageType& f) : AbstractFactory(f) {
                                id.appendMatch16(
                                        (uint16_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__HOMEPLUG_1_0_MME);
                            }
                        };

                        class EAP_OVER_LAN_IEEE_802_1X : public AbstractFactory {
                        public:
                            EAP_OVER_LAN_IEEE_802_1X(MessageType& f) : AbstractFactory(f) {
                                id.appendMatch16(
                                        (uint16_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__EAP_OVER_LAN_IEEE_802_1X);
                            }
                        };

                        class PROFINET_PROTOCOL : public AbstractFactory {
                        public:
                            PROFINET_PROTOCOL(MessageType& f) : AbstractFactory(f) {
                                id.appendMatch16(
                                        (uint16_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__PROFINET_PROTOCOL);
                            }
                        };

                        class HYPERSCSI_SCSI_OVER_ETHERNET : public AbstractFactory {
                        public:
                            HYPERSCSI_SCSI_OVER_ETHERNET(MessageType& f) : AbstractFactory(f) {
                                id.appendMatch16(
                                        (uint16_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__HYPERSCSI_SCSI_OVER_ETHERNET);
                            }
                        };

                        class ATA_OVER_ETHERNET : public AbstractFactory {
                        public:
                            ATA_OVER_ETHERNET(MessageType& f) : AbstractFactory(f) {
                                id.appendMatch16(
                                        (uint16_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__ATA_OVER_ETHERNET);
                            }
                        };

                        class ETHERCAT_PROTOCOL : public AbstractFactory {
                        public:
                            ETHERCAT_PROTOCOL(MessageType& f) : AbstractFactory(f) {
                                id.appendMatch16(
                                        (uint16_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__ETHERCAT_PROTOCOL);
                            }
                        };

                        class PROVIDER_BRIDGING_IEEE_802_1AD_SHORTEST_PATH_BRIDGING_IEEE_802_LAQ
                                : public AbstractFactory {
                        public:
                            PROVIDER_BRIDGING_IEEE_802_1AD_SHORTEST_PATH_BRIDGING_IEEE_802_LAQ(MessageType& f)
                                    : AbstractFactory(f) {
                                id.appendMatch16(
                                        (uint16_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__PROVIDER_BRIDGING_IEEE_802_1AD_SHORTEST_PATH_BRIDGING_IEEE_802_LAQ);
                            }
                        };

                        class ETHERNET_POWERLINK : public AbstractFactory {
                        public:
                            ETHERNET_POWERLINK(MessageType& f) : AbstractFactory(f) {
                                id.appendMatch16(
                                        (uint16_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__ETHERNET_POWERLINK);
                            }
                        };

                        class LLDP : public AbstractFactory {
                        public:
                            LLDP(MessageType& f) : AbstractFactory(f) {
                                id.appendMatch16(
                                        (uint16_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__LLDP);
                            }
                        };

                        class SERCOS_III : public AbstractFactory {
                        public:
                            SERCOS_III(MessageType& f) : AbstractFactory(f) {
                                id.appendMatch16(
                                        (uint16_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__SERCOS_III);
                            }
                        };

                        class HOMEPLUG_AV_MME : public AbstractFactory {
                        public:
                            HOMEPLUG_AV_MME(MessageType& f) : AbstractFactory(f) {
                                id.appendMatch16(
                                        (uint16_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__HOMEPLUG_AV_MME);
                            }
                        };

                        class MEDIA_REDUNDANCY_PROTOCOL_IEC62439_2 : public AbstractFactory {
                        public:
                            MEDIA_REDUNDANCY_PROTOCOL_IEC62439_2(MessageType& f) : AbstractFactory(f) {
                                id.appendMatch16(
                                        (uint16_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__MEDIA_REDUNDANCY_PROTOCOL_IEC62439_2);
                            }
                        };

                        class MAC_SECURITY_IEEE_802_1AE : public AbstractFactory {
                        public:
                            MAC_SECURITY_IEEE_802_1AE(MessageType& f) : AbstractFactory(f) {
                                id.appendMatch16(
                                        (uint16_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__MAC_SECURITY_IEEE_802_1AE);
                            }
                        };

                        class PTP_OVER_ETHERNET_IEEE_1588 : public AbstractFactory {
                        public:
                            PTP_OVER_ETHERNET_IEEE_1588(MessageType& f) : AbstractFactory(f) {
                                id.appendMatch16(
                                        (uint16_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__PTP_OVER_ETHERNET_IEEE_1588);
                            }
                        };

                        class IEEE_802_1AG_CONNECTIVITY_FAULT_MANAGEMENT_CFM_PROTOCOL_ITU_T_RECOMMENDATION_Y_1731_OAM
                                : public AbstractFactory {
                        public:
                            IEEE_802_1AG_CONNECTIVITY_FAULT_MANAGEMENT_CFM_PROTOCOL_ITU_T_RECOMMENDATION_Y_1731_OAM(
                                    MessageType& f) : AbstractFactory(f) {
                                id.appendMatch16(
                                        (uint16_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__IEEE_802_1AG_CONNECTIVITY_FAULT_MANAGEMENT_CFM_PROTOCOL_ITU_T_RECOMMENDATION_Y_1731_OAM);
                            }
                        };

                        class FCOE : public AbstractFactory {
                        public:
                            FCOE(MessageType& f) : AbstractFactory(f) {
                                id.appendMatch16(
                                        (uint16_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__FCOE);
                            }
                        };

                        class FCOE_INITIALIZATION_PROTOCOL : public AbstractFactory {
                        public:
                            FCOE_INITIALIZATION_PROTOCOL(MessageType& f) : AbstractFactory(f) {
                                id.appendMatch16(
                                        (uint16_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__FCOE_INITIALIZATION_PROTOCOL);
                            }
                        };

                        class ROCE : public AbstractFactory {
                        public:
                            ROCE(MessageType& f) : AbstractFactory(f) {
                                id.appendMatch16(
                                        (uint16_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__ROCE);
                            }
                        };

                        class HSR : public AbstractFactory {
                        public:
                            HSR(MessageType& f) : AbstractFactory(f) {
                                id.appendMatch16(
                                        (uint16_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__HSR);
                            }
                        };

                        class ETHERNET_CONFIGURATION_TESTING_PROTOCOL : public AbstractFactory {
                        public:
                            ETHERNET_CONFIGURATION_TESTING_PROTOCOL(MessageType& f) : AbstractFactory(f) {
                                id.appendMatch16(
                                        (uint16_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__ETHERNET_CONFIGURATION_TESTING_PROTOCOL);
                            }
                        };

                        class LLT : public AbstractFactory {
                        public:
                            LLT(MessageType& f) : AbstractFactory(f) {
                                id.appendMatch16(
                                        (uint16_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP__LLT);
                            }
                        };

                        class CUSTOM_PROTOCOL : public AbstractFactory {
                        public:
                            CUSTOM_PROTOCOL(MessageType& f, uint16_t value) : AbstractFactory(f) {
                                id.appendMatch16((uint16_t) value);
                            }
                        };
                        ...
                        AUDIO_VIDEO_TRANSPORT_PROTOCOL_AS_DEFINED_IN_IEEE_STD_1722_2011 audio_video_transport_protocol_as_defined_in_ieee_std_1722_2011() {
                            return AUDIO_VIDEO_TRANSPORT_PROTOCOL_AS_DEFINED_IN_IEEE_STD_1722_2011(id);
                        }
                        ...
                        REVERSE_ADDRESS_RESOLUTION_PROTOCOL reverse_address_resolution_protocol() {
                            return REVERSE_ADDRESS_RESOLUTION_PROTOCOL(id);
                        }

                        APPLETALK_ETHERTALK appletalk_ethertalk() { return APPLETALK_ETHERTALK(id); }

                        APPLETALK_ADDRESS_RESOLUTION_PROTOCOL_AARP appletalk_address_resolution_protocol_aarp() {
                            return APPLETALK_ADDRESS_RESOLUTION_PROTOCOL_AARP(id);
                        }

                        VLAN_TAGGED_FRAME_IEEE_802_1Q_SHORTEST_PATH_BRIDGING_IEEE_802_1AQ vlan_tagged_frame_ieee_802_1q_shortest_path_bridging_ieee_802_1aq() {
                            return VLAN_TAGGED_FRAME_IEEE_802_1Q_SHORTEST_PATH_BRIDGING_IEEE_802_1AQ(id);
                        }
                        ...
                        HYPERSCSI_SCSI_OVER_ETHERNET hyperscsi_scsi_over_ethernet() {
                            return HYPERSCSI_SCSI_OVER_ETHERNET(id);
                        }
                        ...
                        PROVIDER_BRIDGING_IEEE_802_1AD_SHORTEST_PATH_BRIDGING_IEEE_802_LAQ provider_bridging_ieee_802_1ad_shortest_path_bridging_ieee_802_laq() {
                            return PROVIDER_BRIDGING_IEEE_802_1AD_SHORTEST_PATH_BRIDGING_IEEE_802_LAQ(id);
                        }
                        ...
                        MEDIA_REDUNDANCY_PROTOCOL_IEC62439_2 media_redundancy_protocol_iec62439_2() {
                            return MEDIA_REDUNDANCY_PROTOCOL_IEC62439_2(id);
                        }

                        MAC_SECURITY_IEEE_802_1AE mac_security_ieee_802_1ae() { return MAC_SECURITY_IEEE_802_1AE(id); }

                        PTP_OVER_ETHERNET_IEEE_1588 ptp_over_ethernet_ieee_1588() {
                            return PTP_OVER_ETHERNET_IEEE_1588(id);
                        }

                        IEEE_802_1AG_CONNECTIVITY_FAULT_MANAGEMENT_CFM_PROTOCOL_ITU_T_RECOMMENDATION_Y_1731_OAM ieee_802_1ag_connectivity_fault_management_cfm_protocol_itu_t_recommendation_y_1731_oam() {
                            return IEEE_802_1AG_CONNECTIVITY_FAULT_MANAGEMENT_CFM_PROTOCOL_ITU_T_RECOMMENDATION_Y_1731_OAM(
                                    id);
                        }

                        FCOE fcoe() { return FCOE(id); }

                        FCOE_INITIALIZATION_PROTOCOL fcoe_initialization_protocol() {
                            return FCOE_INITIALIZATION_PROTOCOL(id);
                        }
                        ...
                        ETHERNET_CONFIGURATION_TESTING_PROTOCOL ethernet_configuration_testing_protocol() {
                            return ETHERNET_CONFIGURATION_TESTING_PROTOCOL(id);
                        }
                    ...
                    MULTICAST_GROUP multicast_group_default() {
                        return MULTICAST_GROUP(id,
                                               TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_IN__MULTICAST_GROUP_DEFAULT);
                    }
                };
                ...
                public:
                    FLOW_REMOVED(MessageType& f) : AbstractFactory(f) {
                        id.appendMatch8((uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__FLOW_REMOVED);
                    }
                };
                ...
                public:
                    PORT_STATUS(MessageType& f) : AbstractFactory(f) {
                        id.appendMatch8((uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PORT_STATUS);
                    }
                };
                ...
                public:
                    PACKET_OUT(MessageType& f) : AbstractFactory(f) {
                        id.appendMatch8((uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__PACKET_OUT);
                    }
                };
                ...
                public:
                    FLOW_MOD(MessageType& f) : AbstractFactory(f) {
                        id.appendMatch8((uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__FLOW_MOD);
                    }
                };
                ...
                public:
                    OF_1_0_PORT_MOD_OF_1_3_GROUP_MOD(MessageType& f) : AbstractFactory(f) {
                        id.appendMatch8(
                                (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__OF_1_0_PORT_MOD_OF_1_3_GROUP_MOD);
                    }
                };
                ...
                public:
                    OF_1_0_STATS_REQUEST_OF_1_3_PORT_MOD(MessageType& f) : AbstractFactory(f) {
                        id.appendMatch8(
                                (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__OF_1_0_STATS_REQUEST_OF_1_3_PORT_MOD);
                    }
                };
                ...
                public:
                    OF_1_0_STATS_REPLY_OF_1_3_TABLE_MOD(MessageType& f) : AbstractFactory(f) {
                        id.appendMatch8(
                                (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__OF_1_0_STATS_REPLY_OF_1_3_TABLE_MOD);
                    }
                };
                ...
                public:
                    OF_1_0_BARRIER_REQUEST_OF_1_3_MULTIPART_REQUEST(MessageType& f) : AbstractFactory(f) {
                        id.appendMatch8(
                                (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__OF_1_0_BARRIER_REQUEST_OF_1_3_MULTIPART_REQUEST);
                    }
                };
                ...
                public:
                    OF_1_0_BARRIER_REPLY_OF_1_3_MULTIPART_REPLY(MessageType& f) : AbstractFactory(f) {
                        id.appendMatch8(
                                (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__OF_1_0_BARRIER_REPLY_OF_1_3_MULTIPART_REPLY);
                    }
                };
                ...
                public:
                    OF_1_0_QUEUE_GET_CONFIG_REQUEST_OF_1_3_BARRIER_REQUEST(MessageType& f) : AbstractFactory(f) {
                        id.appendMatch8(
                                (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__OF_1_0_QUEUE_GET_CONFIG_REQUEST_OF_1_3_BARRIER_REQUEST);
                    }
                };
                ...
                public:
                    OF_1_0_QUEUE_GET_CONFIG_REPLY_OF_1_3_BARRIER_REPLY(MessageType& f) : AbstractFactory(f) {
                        id.appendMatch8(
                                (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__OF_1_0_QUEUE_GET_CONFIG_REPLY_OF_1_3_BARRIER_REPLY);
                    }
                };
                ...
                public:
                    OF_1_3_QUEUE_GET_CONFIG_REQUEST(MessageType& f) : AbstractFactory(f) {
                        id.appendMatch8(
                                (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__OF_1_3_QUEUE_GET_CONFIG_REQUEST);
                    }
                };
                ...
                public:
                    OF_1_3_QUEUE_GET_CONFIG_REPLY(MessageType& f) : AbstractFactory(f) {
                        id.appendMatch8(
                                (uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__OF_1_3_QUEUE_GET_CONFIG_REPLY);
                    }
                };
                ...
                public:
                    ROLE_RQUEST(MessageType& f) : AbstractFactory(f) {
                        id.appendMatch8((uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__ROLE_RQUEST);
                    }
                };
                ...
                public:
                    ROLE_REPLY(MessageType& f) : AbstractFactory(f) {
                        id.appendMatch8((uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__ROLE_REPLY);
                    }
                };
                ...
                public:
                    GET_ASYNC_REQUEST(MessageType& f) : AbstractFactory(f) {
                        id.appendMatch8((uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__GET_ASYNC_REQUEST);
                    }
                };
                ...
                public:
                    GET_ASYNC_REPLY(MessageType& f) : AbstractFactory(f) {
                        id.appendMatch8((uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__GET_ASYNC_REPLY);
                    }
                };
                ...
                public:
                    SET_ASYNC(MessageType& f) : AbstractFactory(f) {
                        id.appendMatch8((uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__SET_ASYNC);
                    }
                };
                ...
                public:
                    METER_MOD(MessageType& f) : AbstractFactory(f) {
                        id.appendMatch8((uint8_t) TOPIC_VAL__FROM__SWITCH_ADAPTER__OPENFLOW__METER_MOD);
                    }
                };
    ...
    public:
        ...
        public:
            SWITCH_ADAPTER(MessageType& f) : AbstractFactory(f) {
                id.appendMatch16((uint16_t) TOPIC_VAL__REQUEST__SWITCH_ADAPTER);
            }

            class OPENFLOW : public AbstractFactory {
            public:
                OPENFLOW(MessageType& f) : AbstractFactory(f) {
                    id.appendMatch8((uint8_t) TOPIC_VAL__REQUEST__SWITCH_ADAPTER__OPENFLOW);
                }

                class HANDLE_OPENFLOW_MESSAGE : public AbstractFactory {
                public:
                    HANDLE_OPENFLOW_MESSAGE(MessageType& f) : AbstractFactory(f) {
                        id.appendMatch8(
                                (uint8_t) TOPIC_VAL__REQUEST__SWITCH_ADAPTER__OPENFLOW__HANDLE_OPENFLOW_MESSAGE);
                    }
                };
    ...
    public:
        ...
        public:
            SWITCH_ADAPTER(MessageType& f) : AbstractFactory(f) {
                id.appendMatch16((uint16_t) TOPIC_VAL__REPLY__SWITCH_ADAPTER);
            }

            class OPENFLOW : public AbstractFactory {
            public:
                OPENFLOW(MessageType& f) : AbstractFactory(f) {
                    id.appendMatch8((uint8_t) TOPIC_VAL__REPLY__SWITCH_ADAPTER__OPENFLOW);
                }

                class HANDLE_OPENFLOW_MESSAGE : public AbstractFactory {
                public:
                    HANDLE_OPENFLOW_MESSAGE(MessageType& f) : AbstractFactory(f) {
                        id.appendMatch8((uint8_t) TOPIC_VAL__REPLY__SWITCH_ADAPTER__OPENFLOW__HANDLE_OPENFLOW_MESSAGE);
                    }
                };
