...
namespace topologymodule_topics {
    ...
    public:
        ...
        public:
            TOPOLOGY_MODULE(MessageType& f) : AbstractFactory(f) {
                id.appendMatch16((uint16_t) TOPIC_VAL__FROM__TOPOLOGY_MODULE);
            }

            class TOPOLOGY_CHANGED_EVENT : public AbstractFactory {
            public:
                TOPOLOGY_CHANGED_EVENT(MessageType& f) : AbstractFactory(f) {
                    id.appendMatch8((uint8_t) TOPIC_VAL__FROM__TOPOLOGY_MODULE__TOPOLOGY_CHANGED_EVENT);
                }
            };
    ...
    public:
        ...
        public:
            TOPOLOGY_MODULE(MessageType& f) : AbstractFactory(f) {
                id.appendMatch16((uint16_t) TOPIC_VAL__REQUEST__TOPOLOGY_MODULE);
            }

            class GET_TOPOLOGY : public AbstractFactory {
            public:
                GET_TOPOLOGY(MessageType& f) : AbstractFactory(f) {
                    id.appendMatch8((uint8_t) TOPIC_VAL__REQUEST__TOPOLOGY_MODULE__GET_TOPOLOGY);
                }
            };
    ...
    public:
        ...
        public:
            TOPOLOGY_MODULE(MessageType& f) : AbstractFactory(f) {
                id.appendMatch16((uint16_t) TOPIC_VAL__REPLY__TOPOLOGY_MODULE);
            }

            class GET_TOPOLOGY : public AbstractFactory {
            public:
                GET_TOPOLOGY(MessageType& f) : AbstractFactory(f) {
                    id.appendMatch8((uint8_t) TOPIC_VAL__REPLY__TOPOLOGY_MODULE__GET_TOPOLOGY);
                }
            };
