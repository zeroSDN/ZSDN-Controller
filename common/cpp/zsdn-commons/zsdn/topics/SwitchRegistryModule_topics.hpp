...
namespace switchregistrymodule_topics {
    ...
    public:
        ...
        public:
            SWITCH_REGISTRY_MODULE(MessageType& f) : AbstractFactory(f) {
                id.appendMatch16((uint16_t) TOPIC_VAL__FROM__SWITCH_REGISTRY_MODULE);
            }

            class SWITCH_EVENT : public AbstractFactory {
            public:
                SWITCH_EVENT(MessageType& f) : AbstractFactory(f) {
                    id.appendMatch8((uint8_t) TOPIC_VAL__FROM__SWITCH_REGISTRY_MODULE__SWITCH_EVENT);
                }

                class ADDED : public AbstractFactory {
                public:
                    ADDED(MessageType& f) : AbstractFactory(f) {
                        id.appendMatch8((uint8_t) TOPIC_VAL__FROM__SWITCH_REGISTRY_MODULE__SWITCH_EVENT__ADDED);
                    }
                };
                ...
                public:
                    REMOVED(MessageType& f) : AbstractFactory(f) {
                        id.appendMatch8((uint8_t) TOPIC_VAL__FROM__SWITCH_REGISTRY_MODULE__SWITCH_EVENT__REMOVED);
                    }
                };
                ...
                public:
                    CHANGED(MessageType& f) : AbstractFactory(f) {
                        id.appendMatch8((uint8_t) TOPIC_VAL__FROM__SWITCH_REGISTRY_MODULE__SWITCH_EVENT__CHANGED);
                    }
                };
    ...
    public:
        ...
        public:
            SWITCH_REGISTRY_MODULE(MessageType& f) : AbstractFactory(f) {
                id.appendMatch16((uint16_t) TOPIC_VAL__REQUEST__SWITCH_REGISTRY_MODULE);
            }

            class GET_ALL_SWITCHES : public AbstractFactory {
            public:
                GET_ALL_SWITCHES(MessageType& f) : AbstractFactory(f) {
                    id.appendMatch8((uint8_t) TOPIC_VAL__REQUEST__SWITCH_REGISTRY_MODULE__GET_ALL_SWITCHES);
                }
            };

            class GET_SWITCH_BY_ID : public AbstractFactory {
            public:
                GET_SWITCH_BY_ID(MessageType& f) : AbstractFactory(f) {
                    id.appendMatch8((uint8_t) TOPIC_VAL__REQUEST__SWITCH_REGISTRY_MODULE__GET_SWITCH_BY_ID);
                }
            };
    ...
    public:
        ...
        public:
            SWITCH_REGISTRY_MODULE(MessageType& f) : AbstractFactory(f) {
                id.appendMatch16((uint16_t) TOPIC_VAL__REPLY__SWITCH_REGISTRY_MODULE);
            }

            class GET_ALL_SWITCHES : public AbstractFactory {
            public:
                GET_ALL_SWITCHES(MessageType& f) : AbstractFactory(f) {
                    id.appendMatch8((uint8_t) TOPIC_VAL__REPLY__SWITCH_REGISTRY_MODULE__GET_ALL_SWITCHES);
                }
            };
            ...
            public:
                GET_SWITCH_BY_ID(MessageType& f) : AbstractFactory(f) {
                    id.appendMatch8((uint8_t) TOPIC_VAL__REPLY__SWITCH_REGISTRY_MODULE__GET_SWITCH_BY_ID);
                }
            };
