...
namespace linkdiscoverymodule_topics {
    ...
    public:
        ...
        public:
            LINK_DISCOVERY_MODULE(MessageType& f) : AbstractFactory(f) {
                id.appendMatch16((uint16_t) TOPIC_VAL__FROM__LINK_DISCOVERY_MODULE);
            }

            class SWITCH_LINK_EVENT : public AbstractFactory {
            public:
                SWITCH_LINK_EVENT(MessageType& f) : AbstractFactory(f) {
                    id.appendMatch8((uint8_t) TOPIC_VAL__FROM__LINK_DISCOVERY_MODULE__SWITCH_LINK_EVENT);
                }

                class ADDED : public AbstractFactory {
                public:
                    ADDED(MessageType& f) : AbstractFactory(f) {
                        id.appendMatch8((uint8_t) TOPIC_VAL__FROM__LINK_DISCOVERY_MODULE__SWITCH_LINK_EVENT__ADDED);
                    }
                };
                ...
                public:
                    REMOVED(MessageType& f) : AbstractFactory(f) {
                        id.appendMatch8((uint8_t) TOPIC_VAL__FROM__LINK_DISCOVERY_MODULE__SWITCH_LINK_EVENT__REMOVED);
                    }
                };
    ...
    public:
        ...
        public:
            LINK_DISCOVERY_MODULE(MessageType& f) : AbstractFactory(f) {
                id.appendMatch16((uint16_t) TOPIC_VAL__REQUEST__LINK_DISCOVERY_MODULE);
            }

            class GET_ALL_SWITCH_LINKS : public AbstractFactory {
            public:
                GET_ALL_SWITCH_LINKS(MessageType& f) : AbstractFactory(f) {
                    id.appendMatch8((uint8_t) TOPIC_VAL__REQUEST__LINK_DISCOVERY_MODULE__GET_ALL_SWITCH_LINKS);
                }
            };

            class GET_LINKS_FROM_SWITCH : public AbstractFactory {
            public:
                GET_LINKS_FROM_SWITCH(MessageType& f) : AbstractFactory(f) {
                    id.appendMatch8((uint8_t) TOPIC_VAL__REQUEST__LINK_DISCOVERY_MODULE__GET_LINKS_FROM_SWITCH);
                }
            };

            class GET_LINKS_TO_SWITCH : public AbstractFactory {
            public:
                GET_LINKS_TO_SWITCH(MessageType& f) : AbstractFactory(f) {
                    id.appendMatch8((uint8_t) TOPIC_VAL__REQUEST__LINK_DISCOVERY_MODULE__GET_LINKS_TO_SWITCH);
                }
            };

            class GET_ALL_LINKS_OF_SWITCH : public AbstractFactory {
            public:
                GET_ALL_LINKS_OF_SWITCH(MessageType& f) : AbstractFactory(f) {
                    id.appendMatch8((uint8_t) TOPIC_VAL__REQUEST__LINK_DISCOVERY_MODULE__GET_ALL_LINKS_OF_SWITCH);
                }
            };

            class GET_LINKS_BETWEEN_TWO_SWITCHES : public AbstractFactory {
            public:
                GET_LINKS_BETWEEN_TWO_SWITCHES(MessageType& f) : AbstractFactory(f) {
                    id.appendMatch8(
                            (uint8_t) TOPIC_VAL__REQUEST__LINK_DISCOVERY_MODULE__GET_LINKS_BETWEEN_TWO_SWITCHES);
                }
            };
            ...
            GET_LINKS_BETWEEN_TWO_SWITCHES get_links_between_two_switches() {
                return GET_LINKS_BETWEEN_TWO_SWITCHES(id);
            }
        };
    ...
    public:
        ...
        public:
            LINK_DISCOVERY_MODULE(MessageType& f) : AbstractFactory(f) {
                id.appendMatch16((uint16_t) TOPIC_VAL__REPLY__LINK_DISCOVERY_MODULE);
            }

            class GET_ALL_SWITCH_LINKS : public AbstractFactory {
            public:
                GET_ALL_SWITCH_LINKS(MessageType& f) : AbstractFactory(f) {
                    id.appendMatch8((uint8_t) TOPIC_VAL__REPLY__LINK_DISCOVERY_MODULE__GET_ALL_SWITCH_LINKS);
                }
            };
            ...
            public:
                GET_LINKS_FROM_SWITCH(MessageType& f) : AbstractFactory(f) {
                    id.appendMatch8((uint8_t) TOPIC_VAL__REPLY__LINK_DISCOVERY_MODULE__GET_LINKS_FROM_SWITCH);
                }
            };
            ...
            public:
                GET_LINKS_TO_SWITCH(MessageType& f) : AbstractFactory(f) {
                    id.appendMatch8((uint8_t) TOPIC_VAL__REPLY__LINK_DISCOVERY_MODULE__GET_LINKS_TO_SWITCH);
                }
            };
            ...
            public:
                GET_ALL_LINKS_OF_SWITCH(MessageType& f) : AbstractFactory(f) {
                    id.appendMatch8((uint8_t) TOPIC_VAL__REPLY__LINK_DISCOVERY_MODULE__GET_ALL_LINKS_OF_SWITCH);
                }
            };
            ...
            public:
                GET_LINKS_BETWEEN_TWO_SWITCHES(MessageType& f) : AbstractFactory(f) {
                    id.appendMatch8((uint8_t) TOPIC_VAL__REPLY__LINK_DISCOVERY_MODULE__GET_LINKS_BETWEEN_TWO_SWITCHES);
                }
            };
