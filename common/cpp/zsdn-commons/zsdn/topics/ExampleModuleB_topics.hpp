...
public:
EXAMPLE_MODULE_B(MessageType &f) : AbstractFactory(f) {id.appendMatch16((uint16_t) TOPIC_VAL__TO__EXAMPLE_MODULE_B); }
};
...
class EXAMPLE_MODULE_B : public AbstractFactory {
public:
EXAMPLE_MODULE_B(MessageType &f) : AbstractFactory(f) {id.appendMatch16((uint16_t) TOPIC_VAL__FROM__EXAMPLE_MODULE_B); }
};
...
class EXAMPLE_MODULE_B : public AbstractFactory {
public:
EXAMPLE_MODULE_B(MessageType &f) : AbstractFactory(f) {id.appendMatch16((uint16_t) TOPIC_VAL__REQUEST__EXAMPLE_MODULE_B); }
class SOME_REQUEST : public AbstractFactory {
public:
SOME_REQUEST(MessageType &f) : AbstractFactory(f) {id.appendMatch8((uint8_t) TOPIC_VAL__REQUEST__EXAMPLE_MODULE_B__SOME_REQUEST); }
};
...
class EXAMPLE_MODULE_B : public AbstractFactory {
public:
EXAMPLE_MODULE_B(MessageType &f) : AbstractFactory(f) {id.appendMatch16((uint16_t) TOPIC_VAL__REPLY__EXAMPLE_MODULE_B); }
class SOME_REPLY : public AbstractFactory {
public:
SOME_REPLY(MessageType &f) : AbstractFactory(f) {id.appendMatch8((uint8_t) TOPIC_VAL__REPLY__EXAMPLE_MODULE_B__SOME_REPLY); }
};
