...
java -jar ./hierarchy-builder/hierarchy-builder/target/hierarchy-builder-0.0.1-SNAPSHOT-jar-with-dependencies.jar --source ${SRC_DIR} -r --out ${OUT_DIR} --language java --java_package "zsdn.topics"
