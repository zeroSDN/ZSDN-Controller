...
if java -jar module-creator/target/zsdn-module-creator-1.0.0-jar-with-dependencies.jar -i ${moduleId} -n ${moduleName} -d ${zsdnFolder}/modules/cpp -t ${zsdnFolder}/util/template/cpp/TemplateModule -u ${zsdnFolder}/util/template/cpp/TemplateModule-UT; then
