...
public class RESTModulesControlTest {
	 ...
	 * Tests if /rest/modules/control?id=0:1&action=enable returns status code OK (200)
	 ...
	 * Tests if /rest/modules/control?id=0:1&action=disable returns status code OK (200)
	 * Uses put so there is no further return
	 * 
	 */
	@Test 
	 ...
	 * Tests if /rest/modules/control?id=0:1&action=stop returns status code OK (200)
	 * Uses put so there is no further return
	 * 
	 */
	@Test 
